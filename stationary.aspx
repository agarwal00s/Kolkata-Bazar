<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stationary.aspx.cs" Inherits="stationary" %>
...
<body>
    ...
    <hr/>
        ...
        <div class="horblock">
        <div class="imgblock1">
            <asp:Image ID="Image2" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/ruler.jpg" Width="298px" />
       <div class="imgboxes">
           <asp:Label ID="Label7" runat="server" Text="Price : 5 /- " ForeColor="White"></asp:Label>
           <asp:Label ID="Label8" runat="server" Text="per  piece" ForeColor="White"></asp:Label>
           <br />
        ...
        <div class="imgblock">
            <asp:Image ID="Image1" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/eraser.jpg" Width="298px" />
       <div class="imgboxes">
           <asp:Label ID="Label3" runat="server" Text="Price : 3 /- " ForeColor="White"></asp:Label>
           <asp:Label ID="Label4" runat="server" Text="per  piece" ForeColor="White"></asp:Label>
           <br />
         ...
         <div class="imgblock2">
            <asp:Image ID="Image3" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/pen.jpg" Width="298px" />
       <div class="imgboxes">
           <asp:Label ID="Label11" runat="server" Text="Price : 10 /- " ForeColor="White"></asp:Label>
           <asp:Label ID="Label12" runat="server" Text="per  piece" ForeColor="White"></asp:Label>
           <br />
