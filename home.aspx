    ...
    <hr/>
        ...
        <div class="welcome">
           ...
           <br/>
                ...
                <h5>One Stop-Shop for fresh and handpicked Fruits,Vegetables , daily Groceries and Stationary . 
            </h5>
        </div>
        <div class="bns">
        <asp:Button ID="Button1" runat="server" CssClass="m-btn red" Text="Sign Up" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" CssClass="m-btn red" Text="Sign In" OnClick="Button2_Click" />
            </div>
        <div class="footer">
            <hr />
