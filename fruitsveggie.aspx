<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fruitsveggie.aspx.cs" Inherits="fruitsveggie" %>
...
<body>
    ...
    <hr/>
        ...
        <div class="horblock">
        <div class="imgblock1">
            <asp:Image ID="Image2" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/apple.jpeg" Width="298px" />
       <div class="imgboxes">
        ...
        <div class="imgblock">
            <asp:Image ID="Image1" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/banana.jpeg" Width="298px" />
       <div class="imgboxes">
         ...
         <div class="imgblock2">
            <asp:Image ID="Image3" runat="server" BorderColor="#FFB517" BorderStyle="Solid" Height="265px" ImageUrl="~/Grossary/orange.jpeg" Width="298px" />
       <div class="imgboxes">
